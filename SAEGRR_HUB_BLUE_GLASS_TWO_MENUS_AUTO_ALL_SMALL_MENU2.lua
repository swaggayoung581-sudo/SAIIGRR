...
do
    ...
    second.Size = UDim2.fromOffset(270, 390)
    second.Position = UDim2.new(0.5, 140, 0.5, -195)
    ...
    secondTitle.Size = UDim2.new(1, -58, 0, 32)
    secondTitle.Position = UDim2.fromOffset(12, 7)
    ...
    secondSub.TextSize = 7
    secondSub.TextXAlignment = Enum.TextXAlignment.Left
    secondSub.ZIndex = 21

    local secondClose = Instance.new("TextButton", second)
    secondClose.Size = UDim2.fromOffset(38, 34)
    secondClose.Position = UDim2.new(1, -48, 0, 9)
    ...
    local selectedText = glassRow(second, 55, 58)
    local selectedHeader = Instance.new("TextLabel", selectedText)
    selectedHeader.Size = UDim2.new(1, -14, 0, 17)
    selectedHeader.Position = UDim2.fromOffset(7, 5)
    ...
    selectedName.Size = UDim2.new(1, -14, 0, 27)
    selectedName.Position = UDim2.fromOffset(7, 25)
    ...
    autoFindButton.Size = UDim2.new(1, -20, 0, 25)
    autoFindButton.Position = UDim2.fromOffset(10, 119)
    ...
    -- TP SPEED
    local secondTPSpeedRow = glassRow(second, 150, 38)
    local secondTPSpeedLabel = Instance.new("TextLabel", secondTPSpeedRow)
    secondTPSpeedLabel.Size = UDim2.new(1, -105, 1, 0)
    ...
    secondTPMinus.Size = UDim2.fromOffset(26, 25)
    secondTPMinus.Position = UDim2.new(1, -60, 0.5, -12)
    ...
    secondTPPlus.Size = UDim2.fromOffset(26, 25)
    secondTPPlus.Position = UDim2.new(1, -30, 0.5, -12)
    ...
    -- AUTO STEAL
    local autoStealRow = glassRow(second, 193, 40)
    local autoStealButton = Instance.new("TextButton", autoStealRow)
    autoStealButton.Size = UDim2.new(1, -90, 1, -8)
    autoStealButton.Position = UDim2.fromOffset(6, 4)
    ...
    autoStealStatus.Size = UDim2.fromOffset(78, 14)
    autoStealStatus.Position = UDim2.new(1, -84, 0, 3)
    ...
    eggList.Position = UDim2.fromOffset(10, 239)
    ...
    eggPadding.PaddingTop = UDim.new(0, 4)
    eggPadding.PaddingLeft = UDim.new(0, 4)
    eggPadding.PaddingRight = UDim.new(0, 4)
    eggPadding.PaddingBottom = UDim.new(0, 4)

    -- Status line showing the current auto-find mode.
    local findStatus = Instance.new("TextLabel", second)
    findStatus.Size = UDim2.new(1, -20, 0, 15)
    findStatus.Position = UDim2.fromOffset(10, 347)
    ...
    autoStealButton.MouseButton1Click:Connect(function()
        if not autoStealOn then
            if not selectedUid then
                findStatus.Text = "SELECT AN EGG OR USE AUTO FIND FIRST"
                return
            end
            if hold.isOn() then hold.setEnabled(false) end
            ...
            if ok == false then
                ...
                findStatus.Text = "AUTO STEAL ERROR: " .. tostring(why)
                return
            end
            setSecondAutoVisual(true)
            syncMainAutoVisual(true)
            findStatus.Text = "AUTO STEAL: ON"
        else
